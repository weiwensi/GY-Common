package com.gysoft.utils.util.regex;
...
/**
 * @author 周宁
 * @Date 2018-05-21 21:53
 */
public class RegexUtils {

    /**
     * 验证用户名是否合法
     * @param username 用户名：6-12位（字母、数字、_），区分大小写，以字母开头
     ...
     * 验证手机号码
     *
     * @param mobile 以1开头且长度为11的纯数字字符串
     * @return 验证成功返回true，验证失败返回false
     */
    ...
    /**
     * 替换特殊字符串(如果查询条件中有这些字符串可能会导致查询错误)
     * @param str
     * @return String
     */
    public static String replaceEspStr(String str) {
        ...
        if(keepOrigin){
            ...
            return sb.toString()+str.substring(lastIndex);
        }
    }
