...
public class CodingDecoder {
	...
	private static CodingDecoder decoder;
	public static String getFileCode(File file){
		if(decoder == null){
			decoder = new CodingDecoder();
		}
		return nicename[decoder.detectEncoding(file)];
	}
	...
	public static void main(String argc[]) {
		CodingDecoder sinodetector;
		int result = OTHER;

		argc = new String[1];
		argc[0] = "中文";
		sinodetector = new CodingDecoder();
	 ...
	 * Description: This function looks sendTime the URL contents and assigns it a
	 ...
	 * from the Encoding enumeration (GB2312, HZ, BIG5, EUC_TW, ASCII, or OTHER)
	 * Description: This function looks sendTime the file and assigns it a probability
	 ...
	 * or OTHER) Description: This function looks sendTime the byte array and assigns
