package com.gysoft.utils.util.lambdaexception;
...
public final class LambdaExceptionUtil {
    ...
    public static <T,E extends Exception> ToLongFunction<T> rethrowToLongFunction(ToLongFunctionWithException<T,E> function)throws E{
        return t -> {
            try {
