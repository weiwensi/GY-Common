package com.gysoft.utils.jdbc.dao.impl;
...
import com.gysoft.utils.jdbc.sqlhelp.EntityTools;
...
public class EntityDaoImpl<T, Id extends Serializable> implements EntityDao<T, Id> {
    ...
    public List<T> queryAll() throws Exception {
        String sql = "SELECT * FROM " + tableName + " ORDER BY " + primaryKey + " DESC;";
    ...
    private StringBuilder doCriteriaSelect(Criteria criteria) {
        ...
        if (EmptyUtils.isEmpty(selectFields)) {
    ...
    public <E> Result<E> joinQuery(Class<E> clss, Criteria criteria) throws Exception {
        //表名称为空，帮忙设置下主表
        if(EmptyUtils.isEmpty(criteria.getpTable())){
